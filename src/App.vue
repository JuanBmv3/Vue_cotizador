...
<template>
  <div class="my-20 max-w-lg mx-auto bg-white shadow p-10">
    ...
    <div v-if="total > 0" class="my-5 space-y-3 bg-gray-50 p-5">
        ...
        <p class="text-xl text-gray-500 text-center font-bold">Mensuales {{ formatearDinero(montoMensual) }}</p>
    </div>

    <p v-else class="text-center font-extrabold my-5"> Añade una cantidad y un plazo a pagar</p>
